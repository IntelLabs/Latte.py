      ...
      [=](int low, int high) {
        ...
        for (int _neuron_index_2 = 0; _neuron_index_2 < 28; _neuron_index_2 += 1) {
            ...
            for (int _neuron_index_3 = 0; _neuron_index_3 < 28; _neuron_index_3 += 1) {
                int in_x_0 = (_neuron_index_3 + 0) * 1;
                int _input_offset_3_0 = in_x_0;
                __m512 ___x6_0 = _mm512_load_ps(& ensemble5value[_neuron_index_0][_neuron_index_1_outer][_neuron_index_2][(_neuron_index_3 + 0)][0]);
                for (int j = 0; j < 3; j += 1) {
                    for (int k = 0; k < 3; k += 1) {
                        for (int i_inner = 0; i_inner < 16; i_inner += 4) {
                ...
                _mm512_store_ps(& ensemble5value[_neuron_index_0][_neuron_index_1_outer][_neuron_index_2][(_neuron_index_3 + 0)][0], ___x6_0);
            }
        }
    }
    for (int _neuron_index_2 = 0; _neuron_index_2 < 28; _neuron_index_2 += 1) {
