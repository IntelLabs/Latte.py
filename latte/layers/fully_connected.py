...
def FullyConnectedLayer(net, input_ensemble, num_outputs):
    ...
    # ens.vectorize(direction="backward", loop_var="__unique_loopvar0", factor=latte.core.SIMDWIDTH)
    ...
    # ens.vectorize(direction="backward", loop_var="_neuron_index_1_inner", factor=latte.core.SIMDWIDTH)
