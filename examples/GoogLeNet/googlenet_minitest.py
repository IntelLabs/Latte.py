...
data = MemoryDataLayer(net, (3, 28, 28))
inception_3a_3x3_reduce = ConvLayer(net, data, num_filters=96, kernel=1, stride=1, pad=0)
...
pool2_3x3_s2 = MaxPoolingLayer(net,inception_3a_relu_3x3, kernel=3, stride=2, pad=0)
...
for epoch in range(epoch_size):
    ...
    for i in range(1):
        ...
        data.set_value(np.random.rand(batch_size, 3, 28, 28))
