...
def weight_update_and_check_output(net2,convs, layers, batch_size):
...
inception_3a_1x1 = FullyConnectedLayer(net, pool2_3x3_s2, 64)
...
inception_3a_3x3_reduce =  FullyConnectedLayer(net, pool2_3x3_s2, 96)
...
inception_3a_5x5_reduce = FullyConnectedLayer(net, pool2_3x3_s2, 16)
...
inception_3a_pool_proj = FullyConnectedLayer(net, inception_3a_pool, 32)
...
inception_3b_1x1 = FullyConnectedLayer(net, inception_3a_output, 128)
...
inception_3b_3x3_reduce = FullyConnectedLayer(net, inception_3a_output, 128) 
...
inception_3b_5x5_reduce = FullyConnectedLayer(net,inception_3a_output, 32) 
...
inception_3b_pool_proj = FullyConnectedLayer(net, inception_3b_pool, 64)
...
inception_4a_1x1 = FullyConnectedLayer(net, pool3_3x3_s2, 192)
...
inception_4a_3x3_reduce = FullyConnectedLayer(net, pool3_3x3_s2, 96)
...
inception_4a_5x5_reduce = FullyConnectedLayer(net, pool3_3x3_s2, 16)
...
inception_4a_pool_proj = FullyConnectedLayer(net, inception_4a_pool, 64)
...
pool1_3x3_s2 = MaxPoolingLayer(net, conv1_7x7_s2, kernel=3, stride=2, pad=0)
pool1_norm1 = LRNLayer(net, pool1_3x3_s2, n=5, beta=0.75, alpha=0.0001, k=1.0)
conv2_3x3_reduce = FullyConnectedLayer(net, pool1_norm1, 64)
print (conv2_3x3_reduce.shape)
...
for epoch in range(epoch_size):
    ...
    for i in range(1):
       ...
       # t = time.time()
        ...
        #weight_update_and_check_output(net2,convs, layers, batch_size)
